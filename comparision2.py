    ...
    try:
        ...
        chat_completion = client.chat.completions.create(
            messages=[
                {
                    "role": "system",
                    "content": "You are ForestGuard AI, an expert assistant on deforestation patterns, environmental impact, and conservation strategies.Make the answer as concise as possible with an average of 0-300 tokens in the response."
                },
                {
                    "role": "user",
